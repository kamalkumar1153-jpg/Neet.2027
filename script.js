...
function displayQuestion() {
    ...
    if (filteredQuestions.length > 0) {
        ...
        subjectLabel.innerText = q.subject;
        ...
        q.options.forEach(opt => {
            ...
            btn.onclick = () => {
                ...
                if(opt === q.answer) {
                    btn.style.background = "#2ed573"; // Green
                } else {
                    btn.style.background = "#ff4757"; // Red
                    // Correct answer highlight
                    allBtns.forEach(b => {
                        if(b.innerText === q.answer) b.style.border = "2px solid #2ed573";
                    });
                }
        ...
        qText.innerText = "Is subject mein koi sawal nahi mila.";
        optCont.innerHTML = "";
    }
}
